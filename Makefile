...
clean:
	rm -f test/test1 test/test1.o test/test2 test/test2.o test/sample test/sample.o test/example test/example.o test/activity test/activity.o test/verification test/verification.o $(OBJECTS) $(LIBS) *~
