...
/************************** NETWORK **************************/
  ...
  public:
    ...
    // Attribute Accessors
	  ...
	  inline Entity::Ptr entity(Fwk::String _name) const { return entity_[_name]; }
...
/************************** SEGMENT **************************/
  ...
  public:
    ...
    static inline Expedited expedited() const { return expedited_; }
    static inline Expedited notExpedited() const { return notExpedited_; }
