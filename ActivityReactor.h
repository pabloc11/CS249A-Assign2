...
//  	public:
// 		ProducerActivityReactor(Fwk::Ptr<Activity::Manager> manager, Activity* activity, double rate) : 
...
// 	public:
// 		ConsumerActivityReactor(Fwk::Ptr<Activity::Manager> manager, Activity* activity, double rate) :
// 				Notifiee(activity), rate_(rate), activity_(activity), manager_(manager) {}
// 
//     void onStatus();
// 
